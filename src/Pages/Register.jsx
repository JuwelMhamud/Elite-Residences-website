...
const Register = () => {
    ...
    return (
        <div>
              <div>
      <div className="w-full mx-auto max-w-md p-8 space-y-3 rounded-xl bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
        <h1 className="text-2xl font-bold text-center">Register</h1>
        <form noValidate="" action="" className="space-y-6"  onClick={handleRegister}>
          ...
          <div className="space-y-1 text-sm ">
            ...
            <div className="relative">
              ...
              />
              <span
                className="absolute right-4 mt-4 cursor-pointer text-black "
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 rounded-md border-gray-700 dark:border-gray-300 bg-gray-100 dark:bg-gray-50  dark:text-gray-800 focus:border-violet-400 focus:dark:border-violet-600 text-black"
              />
              <span
                className="absolute right-4 mt-4 cursor-pointer text-black "
                onClick={() => setShowPassword(!showPassword)}
