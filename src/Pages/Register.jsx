          ...
          >
            <div className="space-y-1 text-sm">
              ...
              <input
                ...
                id="name"
                placeholder="Name"
                className="w-full px-4 py-3 rounded-md border-gray-700 dark:border-gray-300 dark:bg-gray-50 text-gray-800 focus:border-violet-400 focus:dark:border-violet-600"
              />
            </div>
            <div className="space-y-1 text-sm">
              <label
